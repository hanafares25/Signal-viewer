...
#image = Image.open( "C:\Users\hanaf\Pictures\Screenshots\Screenshot (10).png")
# ------ HEADER SECTION ---------
with st.container():
    st.subheader("Hi, I am Hana :wave:")
    st.title("Digital Signal Processing")
    st.write("Signal viewer Task 1")
    st.write("[Task 1 >](https://github.com/dina-khalid/DSP_Task1_-13-)")
...
with st.container():
    ...
    with left_column:
        st.header(" What we need to do")
        st.write("##")
        st.write(""" Develop a web application that illustrates multi-channel signal viewer
